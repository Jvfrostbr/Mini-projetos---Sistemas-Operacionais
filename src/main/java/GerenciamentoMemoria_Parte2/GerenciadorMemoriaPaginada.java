...
//                int indiceFisico = encontrarIndiceLivreMemFisica(memoriaFisica);
//                if (indiceFisico != -1) {
...
//            if (!alocada) {
//                int indiceVirtual = encontrarIndiceLivreMemVirtual(memoriaVirtual);
//                if (indiceVirtual != -1) {
...
//    }
//
//    private int encontrarIndiceLivreMemFisica(PaginaFisica[] memoria) {
//        boolean achou = false;
//        int indice = -1;
//
...
//    }
//
//    private int encontrarIndiceLivreMemVirtual(PaginaVirtual[] memoria) {
//        boolean achou = false;
//        int indice = -1;
//
//        for (int i = 0; i < memoria.length && !achou; i++) {
...
////                PaginaFisica paginaFisicaRequisitada =
////
...
////                        int indiceLivre = encontrarIndiceLivreMemFisica(memoriaFisica);
////                        PaginaFisica paginaFisicaAdionada = paginaFisicaRequisitada;
////
////                        if (indiceLivre != -1) {
////                            pageMisses++;
////                            memoriaFisica[indiceLivre] = paginaFisicaRequisitada;  // Adiciona a pagina na memória livre
////                            int indicePagina = procurarIndicePagina(paginaFisicaRequisitada, memoriaVirtual);
////                            memoriaVirtual[indicePagina] = null;           // Remove a página da memória virtual
////                            exibirEstadoMemoria(processo, null, paginaFisicaAdionada, algoritmo, paginaFisicaRequisitada);
////                        }
////                        else {
////                            // Memória cheia, aplica substituição
////                            pageMisses++;
////                            PaginaFisica paginaFisicaRemovida = substituirPagina(algoritmo, paginaFisicaRequisitada);
////                            exibirEstadoMemoria(processo, paginaFisicaRemovida, paginaFisicaAdionada, algoritmo, paginaFisicaRequisitada);
...
//        int indiceVirtual = encontrarIndiceLivreMemFisica(memoriaVirtual);
//        if (indiceVirtual != -1) {
//            memoriaVirtual[indiceVirtual] = paginaFisicaRemovida;
//        }
//
...
//                int indiceVirtual = encontrarIndiceLivreMemFisica(memoriaVirtual);
//                if (indiceVirtual != -1) {
//                    memoriaVirtual[indiceVirtual] = paginaFisicaAtual;
//                }
//
...
//    }
//
//    private int contarPaginasLivres(PaginaFisica[] memoria) {
//        int count = 0;
//        for (PaginaFisica p : memoria) {
//            if (p == null) count++;
//        }
//        return count;
//    }
//
//    private void exibirMatrizMemoria(PaginaFisica[] memoria, int colunas) {
//        for (int i = 0; i < memoria.length; i++) {
//            PaginaFisica p = memoria[i];
//            String id = (p != null) ? p.getNome() : " - ";
...
//    }
//
//    private int procurarIndicePagina(PaginaFisica paginaFisica, PaginaFisica[] memoria){
//        boolean achou = false;
//        int indice = -1;
//
//        for (int i = 0; i < memoria.length && !achou; i++){
//            if(paginaFisica.equals(memoria[i])){
//                achou = true;
//                indice = i;
//            }
//        }
...
//    }
//
//    public Map<ProcessoPaginacao, List<PaginaFisica>> getMapaProcessoPaginas() {
...
//    }
//
//    public PaginaFisica[] getMemoriaVirtual() {
